export const CONFIG = {
  ...
  language: 'Muysca', // This changes the display name for your language
  wordLength: 6, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Brenn', // Put your name here so people know who made this game!
  authorWebsite: 'https://muysca.cubun.org/Usuario:Btromerom', // Put a link to your website or social media here
  wordListSource: 'Diccionario Muysca-Español: muysca.cubun.org', // Describe the source material for your words here
  wordListSourceLink: 'https://muysca.cubun.org/', // Put a link to the source material for your words here
  //
